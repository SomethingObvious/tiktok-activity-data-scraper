...
async def scrape_posts(urls: List[str], favorite_video_ids: List[str], batch_size: int = 5, batch_delay: float = 0) -> List[Dict]:
    ...
    for i in range(0, len(urls), batch_size):
        ...
        # Update JSON file with new data after each batch
        try:
